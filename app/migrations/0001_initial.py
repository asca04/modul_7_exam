    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialist', models.ManyToManyField(to='app.specialist')),
                ('work_time', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.worktime')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(blank=True, db_default=0)),
